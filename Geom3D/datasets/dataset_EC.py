# Credit to https://github.com/divelab/DIG/blob/dig-stable/dig/threedgraph/dataset/DatasetEC.py
...
if __name__ == "__main__":
    for split in ['Train', 'Val', 'Test']:
        ...
        dataset = DatasetEC(root='../../data/EC', split=split)
        print(dataset)
