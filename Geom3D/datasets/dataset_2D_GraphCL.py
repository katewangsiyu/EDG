...
class MoleculeDataset_GraphCL(MoleculeNetDataset2D):
    ...
    def edge_pert(self, data):
        ...
        edge_attr_add_1 = torch.tensor(np.random.randint(bond_dims[0], size=(edge_index_add.shape[1], 1)))
        edge_attr_add_2 = torch.tensor(np.random.randint(bond_dims[1], size=(edge_index_add.shape[1], 1)))
        edge_attr_add_3 = torch.tensor(np.random.randint(bond_dims[2], size=(edge_index_add.shape[1], 1)))
