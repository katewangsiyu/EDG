...
class MoleculeDatasetQM9_3DandMMFF(InMemoryDataset):
    ...
    def __init__(
        ...
        super(MoleculeDatasetQM9_3DandMMFF, self).__init__(
    ...
    def process(self):
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            # convert units
            for t_idx, col in enumerate(self.target_field):
                temp_y[t_idx] *= self.conversion[col]
            data.y = temp_y
            ...
            assert MMFF_data['positions'].size() == data.positions.size()
...
if __name__ == "__main__":
    dataset = MoleculeDatasetQM9_3DandMMFF(root="../../data/molecule_datasets/qm9_MMFF", dataset="qm9", task="gap")
    for i in range(10):
        print(dataset[i])
