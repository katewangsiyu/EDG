...
class MoleculeDatasetGEOMQM9(InMemoryDataset):
    def __init__(
        ...
        **kwargs
        ...
        super(MoleculeDatasetGEOMQM9, self).__init__(
...
class MoleculeDatasetGEOMQM9Test(InMemoryDataset):
    def __init__(
        self,
        root,
        split="train",
        ...
        **kwargs
        ...
        super(MoleculeDatasetGEOMQM9Test, self).__init__(
            root, transform, pre_transform, pre_filter
        )
    ...
    def load(self):
        ...
        #     packed_mol_dict[smiles].append(data)
        ...
        # for smiles, data_list_each_mol in packed_mol_dict.items():
...
if __name__ == "__main__":
    pickle_file_name = "../../data/GEOM_qm9/raw/old_test_data_200.pkl"
    with open(pickle_file_name, "rb") as f:
        data_list = pickle.load(f)
    mol_list = [x.rdmol for x in data_list]
    smiles_list = [x.smiles for x in data_list]
    ...
    neo_pickle_file_name = "../../data/GEOM_qm9/raw/test_data_200.pkl"
