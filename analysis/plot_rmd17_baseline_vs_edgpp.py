...
baseline_naphthalene = os.path.join(project_root, "experiments/run_rMD17_baseline/naphthalene/evaluation_best.pth.npz")
baseline_uracil = os.path.join(project_root, "experiments/run_rMD17_baseline/uracil/evaluation_best.pth.npz")
edgpp_naphthalene = os.path.join(project_root, "experiments/run_rMD17_distillation/SphereNet/naphthalene/evaluation_best.pth.npz")
edgpp_uracil = os.path.join(project_root, "experiments/run_rMD17_distillation/SphereNet/uracil/evaluation_best.pth.npz")
...
plt.tight_layout()
# 保存到当前目录
output_dir = os.path.join(project_root, "analysis/visualization")
os.makedirs(output_dir, exist_ok=True)
plt.savefig(os.path.join(output_dir, 'rMD17_baseline_vs_edgpp.pdf'), dpi=300, bbox_inches='tight')
plt.savefig(os.path.join(output_dir, 'rMD17_baseline_vs_edgpp.png'), dpi=300, bbox_inches='tight')
