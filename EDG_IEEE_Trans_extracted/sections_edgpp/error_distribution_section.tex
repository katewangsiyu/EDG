...
% [Polish] Original: To provide empirical support for the heavy-tailed error structure motivating Proposition...
...
% [Polish] Original: Figure reveals that threshold tuning substantially improves tail performance...consistent with Proposition.
