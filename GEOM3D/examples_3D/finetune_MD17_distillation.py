import sys
sys.path.append("/tmp/pycharm_project_923")
sys.path.append("/mnt/shared-storage-user/qiaojingyang-p/code1/sy/GEOM3D")
sys.path.append("/home/lzeng/workspace/GEOM3D")
...
from examples_3D.distillation_utils import *
...
from examples_3D.logger import Logger
from examples_3D.data_utils import DualCollater
...
if __name__ == "__main__":
    ...
    # Use smaller batch_size for eval to avoid GPU OOM on large molecules
    eval_batch_size = 96
    val_loader = DataLoaderClass(val_dataset, eval_batch_size, shuffle=False, num_workers=args.num_workers, **dataloader_kwargs)
    test_loader = DataLoaderClass(test_dataset, eval_batch_size, shuffle=False, num_workers=args.num_workers, **dataloader_kwargs)
