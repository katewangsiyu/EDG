...
def load_checkpoint(pretrained_pth, ED_teacher, EDPredictor, optimizer=None, lr_scheduler=None, logger=None):
    ...
    if os.path.isfile(pretrained_pth):
        ...
        model_list = [("ED_teacher", ED_teacher), ("EDPredictor", EDPredictor)]
