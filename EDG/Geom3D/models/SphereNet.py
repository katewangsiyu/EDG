...
class update_v(torch.nn.Module):
    ...
    def forward(self, e, i, extract_representation=False):
        _, e2 = e
...
class SphereNet(torch.nn.Module):
    ...
    def forward(self, z, pos, batch, extract_representation=False):
        ...
        v = self.init_v(e, i, extract_representation=extract_representation)
        u = self.init_u(
        ...
        for update_e, update_v, update_u in zip(
            ...
            v = update_v(e, i, extract_representation=extract_representation)
