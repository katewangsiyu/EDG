...
def load_checkpoint(pretrained_pth, video_teacher, EDPredictor, EKPredictor, EDEvaluator, EKEvaluator,
    ...
    if os.path.isfile(pretrained_pth):
        ...
        model_list = [("video_teacher", video_teacher), ("EDPredictor", EDPredictor), ("EKPredictor", EKPredictor),
