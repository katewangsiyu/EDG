...
def load_checkpoint(pretrained_pth, teacher, propertiesPredictor, atomDistPredictor, boundDistPredictor, geometryPredictor,
    ...
    if os.path.isfile(pretrained_pth):
        ...
        model_list = [("frame_model", teacher), ("propertiesPredictor", propertiesPredictor),
